"use strict";
/* build-hook-start *//*00001*/try { require('/Users/fernando/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '2000f4bdf11625392744a9AQFIBExVVgtUBgtTUgkDVAAFBwxU', mode: 'runtime'}); } catch(cjsError) { try { import('file:///Users/fernando/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '2000f4bdf11625392744a9AQFIBExVVgtUBgtTUgkDVAAFBwxU', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
